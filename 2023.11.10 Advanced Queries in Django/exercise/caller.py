...
# task1 = Task(title="Task 1", description="Description for Task 1", priority="High", creation_date=date(2023, 1, 15), completion_date=date(2023, 1, 25))
# task2 = Task(title="Task 2", description="Description for Task 2", priority="Medium", is_completed=True, creation_date=date(2023, 2, 1), completion_date=date(2023, 2, 10))
# task3 = Task(title="Task 3", description="Description for Task 3", priority="Hard", is_completed=True, creation_date=date(2023, 1, 15), completion_date=date(2023, 1, 20))
# task1.save()
# task2.save()
# task3.save()
...
# exercise1 = Exercise.objects.create(name="Push-ups", category="Strength", difficulty_level=4, duration_minutes=10, repetitions=50)
# exercise2 = Exercise.objects.create(name="Running", category="Cardio", difficulty_level=7, duration_minutes=20, repetitions=0)
