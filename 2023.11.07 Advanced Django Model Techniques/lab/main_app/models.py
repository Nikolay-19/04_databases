...
def validate_menu_categories(description):
    if ("Appetizers" not in description or "Main Course" not in description or "Desserts" not in
            description):
...
class Restaurant(models.Model):
    name = models.CharField(max_length=101, validators=[
    ...
    location = models.CharField(max_length=201, validators=[
