...
from main_app.models import (Restaurant, Menu, RestaurantReview, RegularRestaurantReview, FoodCriticRestaurantReview,
                             MenuReview, ReviewMixin)
from django.core.exceptions import ValidationError

# valid_restaurant = Restaurant(name="Delicious Bistro", location="123 Main Street",
#                               description="A cozy restaurant with a variety of dishes.", rating=5.00)
# try:
...
# invalid_restaurant = Restaurant(name="A", location="A" * 201,
#                                 description="A restaurant with a long name and invalid rating.",rating=5.01)
# try:
...
# valid_menu = Menu(name="Menu at The Delicious Bistro", description="** Appetizers: **\nSpinach and Artichoke Dip\n** "
#                   "Main Course: **\nGrilled Salmon\n** Desserts: **\nChocolate Fondue",
...
# except ValidationError as e:
#     print(f"Validation Error: {e}")
# invalid_menu = Menu(name="Incomplete Menu", description="** Appetizers: **\nSpinach and Artichoke Dip",
#                     restaurant=Restaurant.objects.first())
# try:
...
# print(f"Reviewer name: {review_from_db.reviewer_name}\n"
...
# print(f"Reviewer name: {menu_review_from_db.reviewer_name}\n"
