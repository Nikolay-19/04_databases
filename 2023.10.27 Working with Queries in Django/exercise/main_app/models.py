...
class Meal(models.Model):
    MEAL_TYPE_CHOICES = (('Breakfast', 'Breakfast'),
                         ('Lunch', 'Lunch'),
                         ('Dinner', 'Dinner'),
                         ('Snack', 'Snack'))
...
class Workout(models.Model):
    WORKOUT_TYPE_CHOICES = (('Cardio', 'Cardio'),
                            ('Strength', 'Strength'),
                            ('Yoga', 'Yoga'),
                            ('CrossFit', 'CrossFit'),
...
class Laptop(models.Model):
    LAPTOPS = (("Asus", "Asus"), ("Acer", "Acer"), ("Apple", "Apple"), ("Lenovo", "Lenovo"), ("Dell", "Dell"))
    OSS = (("Windows", "Windows"), ("MacOS", "MacOS"), ("Linux", "Linux"), ("Chrome OS", "Chrome OS"))
    brand = models.CharField(max_length=20, choices=LAPTOPS)
    ...
    operation_system = models.CharField(max_length=20, choices=OSS)
    price = models.DecimalField(max_digits=10, decimal_places=2)
