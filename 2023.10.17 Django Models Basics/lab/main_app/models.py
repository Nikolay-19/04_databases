...
CITIES = [("Sofia", "Sofia"), ("Plovdiv", "Plovdiv"), ("Burgas", "Burgas"), ("Varna", "Varna")]
...
class Department(models.Model):
    ...
    location = models.CharField(max_length=20, blank=True, choices=CITIES)
...
class Project(models.Model):
    ...
    start_date = models.DateField(blank=True, null=True, verbose_name="Start Date", default=datetime.date.today())
